...
describe('MB Rules For Single Dated Expenses', function() {
    it('should Login with Valid use Details', function() {
     ...
     xit('Expense exceeds SSAH funds available-Insufficent fund In CFY',function(){
     ...
     xit('Date Prior to Fund start date -In CFY',function(){
     ...
     xit('Date After fund End date -In CFY',function(){
        element(by.name('expenseDateCtrl')).sendKeys(protractor.Key.chord(protractor.Key.CONTROL, 'a'));
        browser.sleep(2000);
        expect(MBrule.Admins_fee_title()).toEqual('Administration Fee');
     ...
     xit('Add Expense For PFY -Having sufficinet fund & Between fund start/End date',function(){
        element(by.name('expenseDateCtrl')).sendKeys(protractor.Key.chord(protractor.Key.CONTROL, 'a'));
        browser.sleep(2000);
        expect(MBrule.Admins_fee_title()).toEqual('Administration Fee');
     ...
     xit('Adding Expense for PFY with InSufficient FUND-IN PFY',function(){
        MBrule.Expense_list(1);
        browser.sleep(2000);
     ...
     xit('Add expense with Start date Beofore Fund start date- IN PFY',function(){
        element(by.name('expenseDateCtrl')).sendKeys(protractor.Key.chord(protractor.Key.CONTROL, 'a'));
        browser.sleep(2000);
        //expect(MBrule.Admins_fee_title()).toEqual('Administration Fee');
     ...
     xit('Add expense with Start date After Fund End Date- IN PFY',function(){
        element(by.name('expenseDateCtrl')).sendKeys(protractor.Key.chord(protractor.Key.CONTROL, 'a'));
        browser.sleep(2000);
        //expect(MBrule.Admins_fee_title()).toEqual('Administration Fee');
     ...
     xit('Add Expense with date Before PFY Started- date Before 1st April 2018-IN PFY',function(){
        element(by.name('expenseDateCtrl')).sendKeys(protractor.Key.chord(protractor.Key.CONTROL, 'a'));
        browser.sleep(2000);
     ...
     xit('Add Expense For NFY -Having Insufficinet fund & Between fund start/End date',function(){
        element(by.name('expenseDateCtrl')).sendKeys(protractor.Key.chord(protractor.Key.CONTROL, 'a'));
        browser.sleep(1000);
     ...
     xit('Add Expense For NFY Before FUND STRT Date -IN NFY',function(){
        element(by.name('expenseDateCtrl')).sendKeys(protractor.Key.chord(protractor.Key.CONTROL, 'a'));
        browser.sleep(2000);
     ...
     xit('Add Expense For NFY After FUND END Date -IN NFY',function(){
        element(by.name('expenseDateCtrl')).sendKeys(protractor.Key.chord(protractor.Key.CONTROL, 'a'));
        browser.sleep(2000);
     ...
     xit('Add Expense For NFY With Date After NFY  -(After 1st April 2021)',function(){
        element(by.name('expenseDateCtrl')).sendKeys(protractor.Key.chord(protractor.Key.CONTROL, 'a'));
        browser.sleep(2000);
     ...
     xit('Add Expense For NFY -Having sufficinet fund & Between fund start/End date',function(){
        element(by.name('expenseDateCtrl')).sendKeys(protractor.Key.chord(protractor.Key.CONTROL, 'a'));
        browser.sleep(2000);
        element(by.name('expenseDateCtrl')).sendKeys('6/15/2020');
        element(by.name('amountCtrl')).sendKeys(protractor.Key.chord(protractor.Key.CONTROL, 'a'));
...
xdescribe('MB Rules Two Dated Expenses', function() {
    it('Enter The Start date in PFY And End Date in CFY', function() {
      ...
      it('Enter Both Dates With in FUND STARTDATE & ENDDATE With Sufficient FUND-IN PFY',function(){
        ...
        element(by.buttonText('Save')).click();
        browser.sleep(1000);
        expect(MBrule.Expense_Expectation()).toEqual(PFY);
       }); 
